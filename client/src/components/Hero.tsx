...
export default function Hero() {
  ...
  const fullText = "Security is Myth";
      ...
      <div className="container mx-auto px-4 py-24 relative z-10">
        <div className="max-w-4xl mx-auto text-center space-y-8">
          <div className="flex items-center justify-center gap-3 mb-6 animate-float">
            ...
            <Terminal className="w-10 h-10 text-primary animate-pulse-glow" style={{ animationDelay: '0.5s' }} />
          </div>
          
          <h1 
            className="text-6xl md:text-7xl lg:text-8xl font-bold tracking-tight animate-glitch"
            style={{ fontFamily: 'Orbitron, sans-serif' }}
            data-testid="text-name"
          >
            <span className="text-primary drop-shadow-[0_0_15px_hsl(120_100%_50%/0.5)] animate-text-glow">
              PhantomPawn
            </span>
          </h1>
          ...
          <div className="relative inline-block animate-slide-up">
            <p 
              className="text-2xl md:text-3xl tracking-widest uppercase text-primary/90 font-mono"
              data-testid="text-tagline"
            >
              {displayedText}<span className="animate-blink">_</span>
            </p>
            <div className="absolute -bottom-2 left-0 right-0 h-0.5 bg-gradient-to-r from-transparent via-primary to-transparent opacity-50 animate-scan" />
          </div>
